            ...
            <div class="mixitup-gallery">
                ...
                <div class="filters clearfix">
                    <ul class="filter-tabs filter-btns clearfix">
                        ...
                        <li class="filter" data-role="button" data-filter=".children">Attelier</li>
                        <li class="filter" data-role="button" data-filter=".volunteer">Agricole</li>
                        <li class="filter" data-role="button" data-filter=".animals">Publication</li>
                        <li class="filter" data-role="button" data-filter=".donate">Autre</li>
                    </ul>
                </div>
