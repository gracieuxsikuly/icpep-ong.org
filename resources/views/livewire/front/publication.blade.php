        ...
        <div class="container">
            <div class="row">
                <article class="col-md-4 col-sm-6 col-xs-12">
                    <div class="default-blog-news">
                        <figure class="img-holder">
                            <a href="{{ route('detail-evenemt', ['id'=>1]) }}"><img alt="News" src="{{asset('assets/images/blog/1.jpg')}}"></a>
                ...
                <article class="col-md-4 col-sm-6 col-xs-12">
                    <div class="default-blog-news">
                        <figure class="img-holder">
                            <a href="{{ route('detailevenemt', ['id'=>1]) }}"><img alt="News" src="{{asset('assets/images/blog/1.jpg')}}"></a>
